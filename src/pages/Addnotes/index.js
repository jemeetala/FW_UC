...
const AddnotesPage = () => {
  ...
  return (
    <>
      <Column
        className="bg-bluegray_100 font-sourcesanspro items-center justify-start mx-[auto] w-[100%]"
        compId="4582:7218"
        comWidth={1440}
        comHeight={1024}
        compLeft={0}
      ...
      >
        ...
        >
          ...
          <Column
            className="items-start lg:mb-[21px] xl:mb-[24px] mb-[27px] 3xl:mb-[32px] w-[93%]"
            compId="101"
            comWidth={1342}
            comHeight={997}
            compLeft={0}
          ...
          >
            ...
            <Row
              className="bg-gray_100 border border-indigo_50 border-solid items-center justify-end lg:pb-[5px] xl:pb-[6px] pb-[7px] 3xl:pb-[8px] lg:pr-[12px] xl:pr-[14px] pr-[16px] 3xl:pr-[19px] lg:pt-[6px] xl:pt-[7px] pt-[8px] 3xl:pt-[9px] w-[100%]"
              compId="4797:11538"
              comWidth={1342}
              comHeight={55}
              compLeft={0}
            ...
            >
              <Text
                className="font-normal 3xl:mb-[10px] lg:mb-[7px] xl:mb-[8px] mb-[9px] lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] not-italic lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] text-blue_800 w-[auto]"
                compId="4582:7248"
                comWidth={67}
                comHeight={23}
                compLeft={0}
              ...
              <Row
                className="bg-white_A700 border border-gray_201 border-solid items-center justify-center lg:ml-[248px] xl:ml-[283px] ml-[319px] 3xl:ml-[383px] pl-[10px] 3xl:pl-[12px] lg:pl-[7px] xl:pl-[8px] pr-[11px] 3xl:pr-[13px] lg:pr-[8px] xl:pr-[9px] lg:py-[6px] xl:py-[7px] py-[8px] 3xl:py-[9px] rounded-radius4 w-[6%]"
                compId="4582:7673"
                comWidth={84}
                comHeight={40}
                compLeft={319}
              ...
              >
                <Image
                  ...
                  className="lg:h-[13px] xl:h-[15px] h-[16px] 2xl:h-[17px] 3xl:h-[20px] xl:my-[2px] lg:my-[2px] my-[3px] object-contain w-[32%]"
              ...
              ></SelectBox>
              <Button
                className="3xl:ml-[12px] 3xl:p-[9px] bg-white_A700 border border-gray_201 border-solid flex items-center justify-between lg:ml-[7px] lg:p-[6px] ml-[10px] p-[8px] rounded-radius4 text-center w-[6%] xl:ml-[8px] xl:p-[7px]"
                compId="4582:7682"
                comWidth={0}
                comHeight={40}
                compLeft={0}
                ...
                leftIcon={
                  <Image
                    src={"images/img_addtask_1_1.png"}
              ...
              ></SelectBox>
              <SelectBox
                className="bg-transparent font-normal p-[0] lg:pl-[12px] xl:pl-[14px] pl-[16px] 3xl:pl-[19px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_701 w-[100%]"
                compId="4582:7666"
                comWidth={0}
                comHeight={40}
                compLeft={0}
              ...
              ></SelectBox>
              <Button
                className="bg-white_A700 border border-gray_201 border-solid flex lg:h-[32px] xl:h-[36px] h-[40px] 2xl:h-[41px] 3xl:h-[49px] items-center justify-center ml-[10px] 3xl:ml-[12px] lg:ml-[7px] xl:ml-[8px] lg:p-[6px] xl:p-[7px] p-[8px] 3xl:p-[9px] rounded-radius4 lg:w-[31px] xl:w-[35px] w-[40px] 3xl:w-[48px]"
                compId="4582:7262"
                comWidth={40}
                comHeight={40}
                compLeft={10}
              ...
              >
                <Image
                  ...
                  className="w-[24px] h-[24px] flex items-center justify-center lg:w-[18px] lg:h-[19px] xl:w-[21px] xl:h-[22px] 2xl:h-[25px] 3xl:w-[28px] 3xl:h-[29px]"
                  compId="4582:7262"
                  comWidth={40}
                  comHeight={40}
                  compLeft={10}
            ...
            <Column
              className="items-center lg:mt-[12px] xl:mt-[14px] mt-[16px] 3xl:mt-[19px] lg:pl-[12px] xl:pl-[14px] pl-[16px] 3xl:pl-[19px] w-[100%]"
              compId="104"
              comWidth={1342}
              comHeight={854}
              compLeft={0}
            ...
            >
              <Column
                className="bg-bluegray_51 items-start justify-start lg:pb-[224px] xl:pb-[256px] pb-[288px] 3xl:pb-[345px] lg:pl-[18px] xl:pl-[21px] pl-[24px] 3xl:pl-[28px] lg:pt-[18px] xl:pt-[21px] pt-[24px] 3xl:pt-[28px] rounded-radius4 w-[100%]"
                compId="4797:11555"
                comWidth={1326}
                comHeight={854}
                compLeft={0}
              ...
              >
                <Row
                  className="items-start justify-start w-[53%]"
                  compId="4797:11553"
                  comWidth={684}
                  comHeight={70}
                  compLeft={0}
                ...
                >
                  ...
                  />
                  <Column
                    className="items-start justify-start lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] w-[29%]"
                    compId="4582:7340"
                    comWidth={199}
                    comHeight={70}
                    compLeft={8}
                  ...
                  >
                    ...
                    >
                      <Text
                        className="font-semibold lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] text-bluegray_901 w-[auto]"
                        compId="4582:7341"
                        comWidth={126}
                        comHeight={22}
                        compLeft={0}
                  ...
                  <Line
                    className="bg-bluegray_100 h-[2px] lg:mb-[13px] xl:mb-[15px] mb-[17px] 3xl:mb-[20px] lg:ml-[12px] xl:ml-[14px] ml-[16px] 3xl:ml-[19px] rotate-[-90deg] w-[2px]"
                    compId="4582:7750"
                    comWidth={2}
                    comHeight={53}
                    compLeft={16}
                  ...
                  />
                  <Column
                    className="items-start justify-start lg:mb-[17px] xl:mb-[19px] mb-[22px] 3xl:mb-[26px] lg:ml-[10px] xl:ml-[12px] ml-[14px] 3xl:ml-[16px] w-[7%]"
                    compId="4582:7771"
                    comWidth={49}
                    comHeight={48}
                    compLeft={14}
                  ...
                  >
                    <Text
                      className="font-semibold lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-bluegray_400 w-[auto]"
                      compId="4582:7761"
                      comWidth={39}
                      comHeight={22}
                      compLeft={0}
                    ...
                    <Text
                      className="font-bold lg:h-[18px] xl:h-[20px] h-[22px] 2xl:h-[23px] 3xl:h-[27px] xl:mt-[3px] lg:mt-[3px] mt-[4px] lg:text-[15px] xl:text-[17px] text-[20px] 3xl:text-[24px] text-bluegray_901 w-[auto]"
                      compId="4582:7762"
                      comWidth={22}
                      comHeight={22}
                      compLeft={0}
                  ...
                  <Column
                    className="items-start justify-start lg:mb-[17px] xl:mb-[19px] mb-[22px] 3xl:mb-[26px] lg:ml-[10px] xl:ml-[12px] ml-[14px] 3xl:ml-[16px] xl:pb-[1px] lg:pb-[1px] pb-[2px] pt-[1px] w-[18%]"
                    compId="4582:7772"
                    comWidth={126}
                    comHeight={48}
                    compLeft={14}
                  ...
                  >
                    <Row
                      className="items-center justify-start w-[88%]"
                      compId="4582:7789"
                      comWidth={111}
                      comHeight={22}
                      compLeft={0}
                    ...
                    >
                      ...
                      <Image
                        ...
                        className="lg:h-[16px] xl:h-[18px] h-[20px] 2xl:h-[21px] 3xl:h-[25px] lg:ml-[4px] xl:ml-[5px] ml-[6px] 3xl:ml-[7px] my-[1px] object-contain lg:w-[15px] xl:w-[17px] w-[20px] 3xl:w-[24px]"
                    ...
                    <Row
                      className="items-center justify-start ml-[1px] lg:mt-[5px] xl:mt-[6px] mt-[7px] 3xl:mt-[8px] w-[89%]"
                      compId="4582:7790"
                      comWidth={112}
                      comHeight={15}
                      compLeft={1}
                    ...
                    >
                      ...
                      <Image
                        ...
                        className="lg:h-[12px] xl:h-[14px] h-[15px] 2xl:h-[16px] 3xl:h-[19px] lg:ml-[5px] xl:ml-[6px] ml-[7px] 3xl:ml-[8px] object-contain w-[14%]"
                  ...
                  <Text
                    className="font-semibold lg:mb-[36px] xl:mb-[41px] mb-[47px] 3xl:mb-[56px] lg:ml-[10px] xl:ml-[12px] ml-[14px] 3xl:ml-[16px] mt-[1px] lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-blue_800 w-[auto]"
                    compId="4582:7803"
                    comWidth={143}
                    comHeight={22}
                    compLeft={14}
                ...
                <Row
                  className="items-start justify-start lg:mt-[24px] xl:mt-[28px] mt-[32px] 3xl:mt-[38px] w-[41%]"
                  compId="4797:11554"
                  comWidth={538}
                  comHeight={440}
                  compLeft={0}
                ...
                >
                  <Column
                    className="items-start justify-start w-[42%]"
                    compId="4582:7884"
                    comWidth={227}
                    comHeight={440}
                    compLeft={0}
                  ...
                  >
                    <Text
                      className="font-normal not-italic lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-bluegray_600 w-[auto]"
                      compId="4582:7821"
                      comWidth={56}
                      comHeight={22}
                      compLeft={0}
                    ...
                    <Text
                      className="font-semibold lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-bluegray_901 w-[auto]"
                      compId="4582:7826"
                      comWidth={152}
                      comHeight={22}
                      compLeft={0}
                    ...
                    <Text
                      className="font-normal lg:mt-[18px] xl:mt-[21px] mt-[24px] 3xl:mt-[28px] not-italic lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-bluegray_600 w-[auto]"
                      compId="4582:7829"
                      comWidth={61}
                      comHeight={22}
                      compLeft={0}
                    ...
                    <Text
                      className="font-semibold lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-bluegray_400 w-[auto]"
                      compId="4582:7830"
                      comWidth={91}
                      comHeight={22}
                      compLeft={0}
                    ...
                    <Text
                      className="font-semibold lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-blue_800 w-[auto]"
                      compId="4582:7833"
                      comWidth={181}
                      comHeight={22}
                      compLeft={0}
                    ...
                    <Text
                      className="bg-bluegray_600 font-normal lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] not-italic xl:p-[3px] lg:p-[3px] p-[4px] rounded-radius4 lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-white_A700 w-[auto]"
                      compId="4582:7883"
                      comWidth={61}
                      comHeight={30}
                      compLeft={0}
                  ...
                  <Column
                    className="bg-white_A700 items-start justify-start lg:mb-[199px] xl:mb-[227px] mb-[256px] 3xl:mb-[307px] lg:py-[6px] xl:py-[7px] py-[8px] 3xl:py-[9px] rounded-radius8 w-[58%]"
                    compId="4797:11541"
                    comWidth={311}
                    comHeight={184}
                    compLeft={0}
                  ...
                  >
                    <Column
                      className="border border-bluegray_51 border-solid items-center justify-start mx-[auto] 3xl:pb-[110px] lg:pb-[71px] xl:pb-[81px] pb-[92px] xl:pl-[10px] pl-[12px] 3xl:pl-[14px] lg:pl-[9px] xl:pt-[10px] pt-[12px] 3xl:pt-[14px] lg:pt-[9px] rounded-radius6 w-[90%]"
                      compId="4797:11540"
                      comWidth={279}
                      comHeight={126}
                      compLeft={16}
                    ...
                    <Column
                      className="items-start xl:mt-[10px] mt-[12px] 3xl:mt-[14px] lg:mt-[9px] w-[100%]"
                      compId="105"
                      comWidth={311}
                      comHeight={1}
                      compLeft={0}
                    ...
                    <Text
                      className="font-semibold lg:mt-[5px] xl:mt-[6px] mt-[7px] 3xl:mt-[8px] mx-[auto] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-blue_800 w-[auto]"
                      compId="4582:7902"
                      comWidth={83}
                      comHeight={22}
                      compLeft={114}
