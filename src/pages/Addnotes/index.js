        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <Text
                className="font-normal 3xl:mb-[10px] lg:mb-[7px] xl:mb-[8px] mb-[9px] lg:ml-[18px] xl:ml-[21px] ml-[24px] 3xl:ml-[28px] lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] not-italic lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] text-bluegray_700 w-[auto]"
                compId="4582:7251"
                comWidth={121}
                comHeight={23}
                compLeft={24}
              ...
              >
                <Input
                  className="bg-transparent border-0 font-normal not-italic p-[0] xl:pl-[10px] pl-[12px] 3xl:pl-[14px] lg:pl-[9px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] placeholder:text-bluegray_700 text-bluegray_700 w-[100%]"
                  WrapClassName="3xl:pl-[12px] 3xl:pr-[13px] 3xl:py-[9px] bg-white_A700 border border-gray_200 border-solid flex lg:pl-[7px] lg:pr-[8px] lg:py-[6px] pl-[10px] pr-[11px] py-[8px] rounded-radius4 w-[11%] xl:pl-[8px] xl:pr-[9px] xl:py-[7px]"
                  compId="4582:7673"
                  comWidth={0}
                  comHeight={40}
                  compLeft={0}
                ...
                ></Input>
                <SelectBox
                  className="bg-transparent font-normal p-[0] xl:pl-[10px] pl-[12px] 3xl:pl-[14px] lg:pl-[9px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_700 w-[100%]"
                  compId="4582:7701"
                  comWidth={0}
                  comHeight={40}
                  compLeft={0}
                ...
                ></SelectBox>
                <Button
                  className="3xl:ml-[12px] 3xl:p-[9px] bg-white_A700 border border-gray_200 border-solid flex items-center justify-between lg:ml-[7px] lg:p-[6px] ml-[10px] p-[8px] rounded-radius4 text-center w-[10%] xl:ml-[8px] xl:p-[7px]"
                  compId="4582:7682"
                  comWidth={0}
                  comHeight={40}
                  compLeft={0}
                ...
                ></SelectBox>
                <SelectBox
                  className="bg-transparent font-normal p-[0] lg:pl-[12px] xl:pl-[14px] pl-[16px] 3xl:pl-[19px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_700 w-[100%]"
                  compId="4582:7666"
                  comWidth={0}
                  comHeight={40}
                  compLeft={0}
                ...
                ></SelectBox>
                <Button
                  className="bg-white_A700 border border-gray_200 border-solid flex lg:h-[32px] xl:h-[36px] h-[40px] 2xl:h-[41px] 3xl:h-[49px] items-center justify-center ml-[10px] 3xl:ml-[12px] lg:ml-[7px] xl:ml-[8px] lg:p-[6px] xl:p-[7px] p-[8px] 3xl:p-[9px] rounded-radius4 lg:w-[31px] xl:w-[35px] w-[40px] 3xl:w-[48px]"
                  compId="4582:7262"
                  comWidth={40}
                  comHeight={40}
                  compLeft={10}
            ...
            <Column
              className="bg-bluegray_51 items-start justify-start lg:ml-[12px] xl:ml-[14px] ml-[16px] 3xl:ml-[19px] lg:mt-[12px] xl:mt-[14px] mt-[16px] 3xl:mt-[19px] lg:pb-[224px] xl:pb-[256px] pb-[288px] 3xl:pb-[345px] lg:pl-[18px] xl:pl-[21px] pl-[24px] 3xl:pl-[28px] lg:pt-[18px] xl:pt-[21px] pt-[24px] 3xl:pt-[28px] rounded-radius4 w-[99%]"
              compId="4797:11555"
              comWidth={1326}
              comHeight={854}
              compLeft={16}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <Button
                        className="bg-white_A700 border border-gray_200 border-solid flex lg:h-[25px] xl:h-[29px] h-[32px] 2xl:h-[33px] 3xl:h-[39px] items-center justify-center lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] 3xl:p-[10px] lg:p-[7px] xl:p-[8px] p-[9px] rounded-radius4 lg:w-[24px] xl:w-[28px] w-[32px] 3xl:w-[38px]"
                        compId="4797:11549"
                        comWidth={32}
                        comHeight={32}
                        compLeft={8}
                  ...
                  />
                  <Column
                    className="items-start justify-start lg:mb-[17px] xl:mb-[19px] mb-[22px] 3xl:mb-[26px] lg:ml-[10px] xl:ml-[12px] ml-[14px] 3xl:ml-[16px] w-[14%]"
                    compId="4582:7771"
                    comWidth={39}
                    comHeight={48}
                    compLeft={14}
                ...
                <Text
                  className="font-semibold lg:mb-[36px] xl:mb-[41px] mb-[47px] 3xl:mb-[56px] lg:ml-[18px] xl:ml-[21px] ml-[24px] 3xl:ml-[28px] mt-[1px] lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-blue_800 w-[auto]"
                  compId="4582:7803"
                  comWidth={143}
                  comHeight={22}
                  compLeft={24}
              ...
              >
                <Column
                  className="items-start justify-start w-[34%]"
                  compId="4582:7884"
                  comWidth={181}
                  comHeight={440}
                  compLeft={0}
                ...
                >
                  ...
                  >
                    <Text
                      className="font-semibold lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-blue_800 w-[auto]"
                      compId="4582:7833"
                      comWidth={181}
                      comHeight={22}
                      compLeft={0}
                ...
                <Column
                  className="bg-white_A700 items-center justify-start lg:mb-[199px] xl:mb-[227px] mb-[256px] 3xl:mb-[307px] lg:ml-[35px] xl:ml-[40px] ml-[46px] 3xl:ml-[55px] lg:py-[6px] xl:py-[7px] py-[8px] 3xl:py-[9px] rounded-radius8 w-[58%]"
                  compId="4797:11541"
                  comWidth={311}
                  comHeight={184}
                  compLeft={46}
                ...
                >
                  ...
                  <Line
                    className="bg-bluegray_51 h-[1px] xl:mt-[10px] mt-[12px] 3xl:mt-[14px] lg:mt-[9px] w-[100%]"
                    compId="4582:7901"
                    comWidth={311}
                    comHeight={1}
                    compLeft={0}
