        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Text
                  className="font-normal lg:my-[6px] xl:my-[7px] my-[8px] 3xl:my-[9px] not-italic lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] text-bluegray_700 w-[auto]"
                  compId="4509:5654"
                  comWidth={126}
                  comHeight={23}
                  compLeft={0}
                ...
                <Button
                  className="3xl:ml-[19px] 3xl:pl-[21px] 3xl:pr-[19px] 3xl:py-[9px] bg-indigo_51 border border-blue_800 border-solid flex items-center justify-between lg:ml-[12px] lg:pl-[14px] lg:pr-[12px] lg:py-[6px] ml-[16px] pl-[18px] pr-[16px] py-[8px] rounded-radius4 text-center w-[37%] xl:ml-[14px] xl:pl-[16px] xl:pr-[14px] xl:py-[7px]"
                  compId="4509:6033"
                  comWidth={0}
                  comHeight={40}
                  compLeft={0}
                ...
                <Button
                  className="3xl:ml-[19px] 3xl:pl-[21px] 3xl:pr-[20px] 3xl:py-[9px] bg-indigo_51 border border-blue_800 border-solid flex items-center justify-between lg:ml-[12px] lg:pl-[14px] lg:pr-[13px] lg:py-[6px] ml-[16px] pl-[18px] pr-[17px] py-[8px] rounded-radius4 text-center w-[21%] xl:ml-[14px] xl:pl-[16px] xl:pr-[15px] xl:py-[7px]"
                  compId="4509:6040"
                  comWidth={0}
                  comHeight={40}
                  compLeft={0}
              ...
              >
                <SelectBox
                  className="bg-bluegray_900 border border-gray_200 border-solid font-normal lg:pl-[6px] xl:pl-[7px] pl-[8px] 3xl:pl-[9px] lg:py-[6px] xl:py-[7px] py-[8px] 3xl:py-[9px] rounded-radius4 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-white_A700 w-[29%]"
                  compId="4509:5658"
                  comWidth={123}
                  comHeight={40}
                  compLeft={0}
                ...
                ></SelectBox>
                <Row
                  className="bg-white_A700 border border-gray_200 border-solid items-center justify-evenly ml-[10px] 3xl:ml-[12px] lg:ml-[7px] xl:ml-[8px] lg:py-[6px] xl:py-[7px] py-[8px] 3xl:py-[9px] rounded-radius4 w-[28%]"
                  compId="4509:5665"
                  comWidth={119}
                  comHeight={40}
                  compLeft={10}
            ...
            <Row
              className="bg-gray_100 border border-gray_200 border-solid items-center justify-start lg:pl-[17px] xl:pl-[20px] pl-[23px] 3xl:pl-[27px] xl:py-[10px] py-[12px] 3xl:py-[14px] lg:py-[9px] w-[100%]"
              compId="4797:9835"
              comWidth={1342}
              comHeight={46}
              compLeft={0}
            ...
            >
              ...
              >
                <Text
                  className="font-semibold lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_901 uppercase w-[auto]"
                  compId="4797:9843"
                  comWidth={132}
                  comHeight={22}
                  compLeft={0}
                ...
                />
                <Text
                  className="font-semibold lg:ml-[10px] xl:ml-[11px] ml-[13px] 3xl:ml-[15px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_901 uppercase w-[auto]"
                  compId="4797:9849"
                  comWidth={121}
                  comHeight={22}
                  compLeft={13}
              ...
              <Text
                className="font-semibold lg:ml-[35px] xl:ml-[40px] ml-[45px] 3xl:ml-[54px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_901 uppercase w-[auto]"
                compId="4797:9852"
                comWidth={86}
                comHeight={22}
                compLeft={45}
              ...
              />
              <Text
                className="font-semibold lg:ml-[45px] xl:ml-[51px] ml-[58px] 3xl:ml-[69px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_901 uppercase w-[auto]"
                compId="4797:9855"
                comWidth={55}
                comHeight={22}
                compLeft={58}
              ...
              />
              <Text
                className="font-semibold 3xl:ml-[110px] lg:ml-[71px] xl:ml-[81px] ml-[92px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_901 uppercase w-[auto]"
                compId="4797:9858"
                comWidth={37}
                comHeight={22}
                compLeft={92}
            ...
            >
              <Row
                className="bg-white_A700 border border-gray_200 border-solid items-center justify-end my-[0] lg:pr-[14px] xl:pr-[16px] pr-[18px] 3xl:pr-[21px] lg:py-[19px] xl:py-[22px] py-[25px] 3xl:py-[30px] w-[100%]"
                compId="4797:9889"
                comWidth={1342}
                comHeight={98}
                compLeft={0}
              ...
              >
                ...
                <Text
                  className="font-semibold font-sourcesanspro lg:ml-[124px] xl:ml-[142px] ml-[160px] 3xl:ml-[192px] lg:my-[10px] xl:my-[11px] my-[13px] 3xl:my-[15px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_901 w-[auto]"
                  compId="4797:9888"
                  comWidth={29}
                  comHeight={22}
                  compLeft={160}
                ...
                <Text
                  className="font-normal font-sourcesanspro lg:ml-[106px] xl:ml-[121px] ml-[137px] 3xl:ml-[164px] lg:my-[10px] xl:my-[11px] my-[13px] 3xl:my-[15px] not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_700 w-[auto]"
                  compId="4797:9887"
                  comWidth={70}
                  comHeight={22}
                  compLeft={137}
                ...
                <Text
                  className="font-normal font-sourcesanspro xl:ml-[106px] ml-[120px] 3xl:ml-[144px] lg:ml-[93px] lg:my-[10px] xl:my-[11px] my-[13px] 3xl:my-[15px] not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_700 w-[auto]"
                  compId="4797:9877"
                  comWidth={67}
                  comHeight={22}
                  compLeft={120}
                ...
                >
                  <Text
                    className="font-normal my-[1px] not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-blue_800 w-[auto]"
                    compId="4797:9878"
                    comWidth={107}
                    comHeight={22}
                    compLeft={0}
            ...
            <Input
              className="bg-transparent border-0 font-normal not-italic lg:pl-[12px] xl:pl-[14px] pl-[16px] 3xl:pl-[19px] lg:pr-[27px] xl:pr-[31px] pr-[35px] 3xl:pr-[42px] lg:py-[14px] xl:py-[16px] py-[18px] 3xl:py-[21px] lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] placeholder:text-bluegray_700 text-bluegray_700 w-[100%]"
