    ...
    <>
      ...
      >
        ...
        >
          ...
          <Column
            className="items-start justify-start lg:mb-[433px] xl:mb-[495px] mb-[557px] 3xl:mb-[668px] w-[93%]"
            compId="41"
            comWidth={1342}
            comHeight={467}
            compLeft={0}
          ...
          >
            ...
            >
              ...
              />
              <Text
                className="font-normal lg:mb-[6px] xl:mb-[7px] mb-[8px] 3xl:mb-[9px] lg:ml-[18px] xl:ml-[21px] ml-[24px] 3xl:ml-[28px] lg:mt-[10px] xl:mt-[12px] mt-[14px] 3xl:mt-[16px] not-italic lg:text-[14px] xl:text-[16px] text-[18px] 3xl:text-[21px] text-bluegray_700 w-[auto]"
                compId="4509:6321"
                comWidth={114}
                comHeight={23}
                compLeft={24}
            ...
            <Row
              className="bg-gray_100 border border-gray_200 border-solid items-start justify-start lg:pl-[60px] xl:pl-[69px] pl-[78px] 3xl:pl-[93px] xl:py-[10px] py-[12px] 3xl:py-[14px] lg:py-[9px] w-[100%]"
              compId="4797:10815"
              comWidth={1342}
              comHeight={46}
              compLeft={0}
            ...
            >
              <Text
                className="font-semibold xl:mt-[2px] lg:mt-[2px] mt-[3px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_900 uppercase w-[auto]"
                compId="4797:10819"
                comWidth={212}
                comHeight={19}
                compLeft={0}
              ...
              <Text
                className="font-semibold lg:mb-[4px] xl:mb-[5px] mb-[6px] 3xl:mb-[7px] xl:ml-[105px] ml-[119px] 3xl:ml-[142px] lg:ml-[92px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_900 uppercase w-[auto]"
                compId="4797:10822"
                comWidth={262}
                comHeight={16}
                compLeft={119}
              ...
              <Text
                className="font-semibold lg:ml-[55px] xl:ml-[63px] ml-[71px] 3xl:ml-[85px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_900 uppercase w-[auto]"
                compId="4797:10827"
                comWidth={65}
                comHeight={22}
                compLeft={71}
              ...
              <Text
                className="font-semibold lg:ml-[64px] xl:ml-[73px] ml-[83px] 3xl:ml-[99px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_900 uppercase w-[auto]"
                compId="4797:10829"
                comWidth={83}
                comHeight={22}
                compLeft={83}
              ...
              <Text
                className="font-semibold ml-[111px] 3xl:ml-[133px] lg:ml-[86px] xl:ml-[98px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_900 uppercase w-[auto]"
                compId="4797:10832"
                comWidth={70}
                comHeight={22}
                compLeft={111}
            ...
            >
              {apiData1?.products?.map((apiData1Ele) => {
                return (
                  <Row
                  ...
                  >
                    ...
                    <Text
                      className="font-normal lg:leading-[17px] xl:leading-[19px] leading-[22.00px] 2xl:leading-[22px] 3xl:leading-[26px] mb-[1px] xl:mt-[2px] lg:mt-[2px] mt-[3px] not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_700 text-left w-[5%]"
                      compId="4797:10865"
                      comWidth={68}
                      comHeight={44}
                      compLeft={0}
                    ...
                    <Text
                      className="font-normal lg:ml-[205px] xl:ml-[234px] ml-[264px] 3xl:ml-[316px] lg:my-[10px] xl:my-[11px] my-[13px] 3xl:my-[15px] not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_700 w-[auto]"
                      compId="4797:10860"
                      comWidth={58}
                      comHeight={22}
                      compLeft={264}
                      ...
                      compType="Text"
                    >
                      {apiData1Ele?.category}
                    </Text>
                    <Text
                      className="font-normal 3xl:ml-[108px] lg:ml-[70px] xl:ml-[80px] ml-[90px] lg:my-[10px] xl:my-[11px] my-[13px] 3xl:my-[15px] not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_700 w-[auto]"
                      compId="4797:10861"
                      comWidth={107}
                      comHeight={22}
                      compLeft={90}
                      ...
                      compType="Text"
                    >
                      {apiData1Ele?.sku_number}
                    </Text>
                    <Text
                      className="font-normal lg:mb-[10px] xl:mb-[11px] mb-[13px] 3xl:mb-[15px] 3xl:ml-[104px] lg:ml-[67px] xl:ml-[77px] ml-[87px] lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_700 w-[auto]"
                      compId="4797:10862"
                      comWidth={147}
                      comHeight={27}
                      compLeft={87}
