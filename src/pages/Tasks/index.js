      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Column
                className="absolute h-[max-content] inset-y-[0] items-center justify-start my-[auto] w-[66%]"
                compId="4798:8683"
                comWidth={885}
                comHeight={836}
                compLeft={0}
              ...
              >
                ...
                <Column
                  className="bg-white_A700 items-center justify-start lg:pb-[13px] xl:pb-[15px] pb-[17px] 3xl:pb-[20px] lg:pl-[12px] xl:pl-[14px] pl-[16px] 3xl:pl-[19px] lg:pt-[14px] xl:pt-[16px] pt-[18px] 3xl:pt-[21px] w-[100%]"
                  compId="4797:9071"
                  comWidth={885}
                  comHeight={58}
                  compLeft={0}
              ...
              <Column
                className="absolute bg-white_A700 border border-gray_201 border-solid items-start justify-center lg:pl-[12px] xl:pl-[14px] pl-[16px] 3xl:pl-[19px] lg:py-[12px] xl:py-[14px] py-[16px] 3xl:py-[19px] w-[34%]"
                compId="4797:9073"
                comWidth={458}
                comHeight={249}
                compLeft={0}
