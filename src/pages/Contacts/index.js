            ...
            >
              ...
              >
                ...
                <Text
                  ...
                  compType="Text"
                >
                  {apiData4?.contacts?.mobile_number}
                </Text>
                <Text
                  className="font-medium lg:ml-[12px] xl:ml-[14px] ml-[16px] 3xl:ml-[19px] lg:my-[5px] xl:my-[6px] my-[7px] 3xl:my-[8px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-black_901 w-[auto]"
                  compId="5032:8157"
                ...
                <Button
                  ...
                  compType="Button"
                >
                  {apiData4?.contacts?.display_name}
                </Button>
                <Image
              ...
              >
                ...
                <Button
                  className="bg-orange_50 font-medium lg:ml-[12px] xl:ml-[14px] ml-[16px] 3xl:ml-[19px] lg:py-[6px] xl:py-[7px] py-[8px] 3xl:py-[9px] rounded-radius155 xl:text-[10px] text-[12px] 3xl:text-[14px] lg:text-[9px] text-center text-orange_900 w-[11%]"
                  compId="5022:8530"
                  comWidth={149}
                  comHeight={31}
                  compLeft={16}
              ...
              >
                ...
                <Button
                  className="bg-deep_orange_50 font-medium lg:ml-[12px] xl:ml-[14px] ml-[16px] 3xl:ml-[19px] lg:py-[6px] xl:py-[7px] py-[8px] 3xl:py-[9px] rounded-radius155 xl:text-[10px] text-[12px] 3xl:text-[14px] lg:text-[9px] text-center text-red_900 w-[11%]"
                  compId="5022:8572"
                  comWidth={149}
                  comHeight={31}
                  compLeft={16}
              ...
              >
                ...
                <Button
                  className="bg-green_50 font-medium lg:ml-[12px] xl:ml-[14px] ml-[16px] 3xl:ml-[19px] lg:py-[6px] xl:py-[7px] py-[8px] 3xl:py-[9px] rounded-radius155 xl:text-[10px] text-[12px] 3xl:text-[14px] lg:text-[9px] text-center text-green_700 w-[6%]"
                  compId="5022:8593"
                  comWidth={83}
                  comHeight={31}
                  compLeft={16}
              ...
              >
                ...
                <Button
                  className="bg-deep_orange_50 font-medium lg:ml-[12px] xl:ml-[14px] ml-[16px] 3xl:ml-[19px] lg:py-[6px] xl:py-[7px] py-[8px] 3xl:py-[9px] rounded-radius155 xl:text-[10px] text-[12px] 3xl:text-[14px] lg:text-[9px] text-center text-red_900 w-[6%]"
                  compId="5022:8656"
                  comWidth={81}
                  comHeight={31}
                  compLeft={16}
              ...
              >
                ...
                <Button
                  className="bg-orange_50 font-medium lg:ml-[12px] xl:ml-[14px] ml-[16px] 3xl:ml-[19px] lg:py-[6px] xl:py-[7px] py-[8px] 3xl:py-[9px] rounded-radius155 xl:text-[10px] text-[12px] 3xl:text-[14px] lg:text-[9px] text-center text-orange_900 w-[5%]"
                  compId="5022:8677"
                  comWidth={71}
                  comHeight={31}
                  compLeft={16}
