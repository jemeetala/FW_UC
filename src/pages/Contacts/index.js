              ...
              >
                ...
                >
                  ...
                  <Text
                    ...
                    compType="Text"
                  >
                    {apiData2?.contacts?.mobile_number}
                  </Text>
                  <Text
                    className="font-medium lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-black_901 w-[auto]"
                    compId="5022:8484"
                ...
                <Text
                  ...
                  compType="Text"
                >
                  {apiData2?.contacts?.open_deals_amount}
                </Text>
                <Text
                ...
                <Button
                  ...
                  compType="Button"
                >
                  {apiData2?.contacts?.display_name}
                </Button>
                <Image
