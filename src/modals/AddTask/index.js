      ...
      >
        <div className="m-[auto] max-h-[97vh] overflow-y-auto">
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Input
                        className="bg-transparent border-0 font-normal not-italic p-[0] pl-[0] lg:pr-[21px] xl:pr-[24px] pr-[28px] 3xl:pr-[33px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] placeholder:text-bluegray_700 text-bluegray_700 w-[100%]"
          ...
          >
            ...
            <Button
              className="bg-bluegray_900 border border-gray_200 border-solid font-normal lg:ml-[6px] xl:ml-[7px] ml-[8px] 3xl:ml-[9px] not-italic lg:py-[6px] xl:py-[7px] py-[8px] 3xl:py-[9px] rounded-radius4 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-center text-white_A700 w-[43%]"
              compId="4712:9382"
              comWidth={60}
              comHeight={39}
              compLeft={8}
