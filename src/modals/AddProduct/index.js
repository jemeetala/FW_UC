    ...
    <>
      ...
      >
        <div className="m-[auto] max-h-[97vh] overflow-y-auto">
          <Stack
            className="lg:h-[419px] xl:h-[480px] h-[538.5px] 2xl:h-[539px] 3xl:h-[647px] w-[100%]"
            compId="4797:11503"
            comWidth={551}
            comHeight={538.5}
            compLeft={0}
          ...
          >
            ...
            >
              <Input
                ...
                WrapClassName="2xl:pb-[16px] 2xl:pt-[15px] 3xl:pb-[19px] 3xl:pl-[19px] 3xl:pr-[24px] 3xl:pt-[18px] bg-gray_100 border border-indigo_50 border-solid flex lg:pl-[12px] lg:pr-[15px] lg:py-[12px] pb-[16.51px] pl-[16px] pr-[20px] pt-[15.54px] w-[100%] xl:pb-[14px] xl:pl-[14px] xl:pr-[17px] xl:pt-[13px]"
                compId="4797:11346"
                comWidth={0}
                comHeight={54.39}
                compLeft={0}
              ...
              ></Input>
              <Row
                className="bg-gray_100 border border-indigo_50 border-solid items-start justify-center lg:mt-[310px] xl:mt-[355px] mt-[399.61px] 2xl:mt-[399px] 3xl:mt-[479px] lg:pb-[2px] pb-[3.5px] 2xl:pb-[3px] xl:pb-[3px] 3xl:pb-[4px] lg:pl-[293px] xl:pl-[335px] pl-[377px] 3xl:pl-[452px] lg:pr-[23px] xl:pr-[26px] pr-[30px] 3xl:pr-[36px] lg:pt-[39px] xl:pt-[45px] pt-[51px] 3xl:pt-[61px] w-[100%]"
                compId="4797:11340"
                comWidth={551}
                comHeight={84.5}
                compLeft={0}
            ...
            <Column
              className="absolute bg-white_A700 inset-x-[0] inset-y-[8%] items-start justify-center lg:pb-[54px] xl:pb-[62px] pb-[70px] 3xl:pb-[84px] lg:pl-[24px] xl:pl-[28px] pl-[32px] 3xl:pl-[38px] lg:pt-[21px] xl:pt-[24px] pt-[27.93px] 2xl:pt-[27px] 3xl:pt-[33px] w-[100%]"
              compId="4797:11502"
              comWidth={551}
              comHeight={450.61}
              compLeft={0}
            ...
            >
              <Text
                className="font-normal xl:ml-[1px] lg:ml-[1px] ml-[2px] not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-black_901 w-[auto]"
              ...
              <Text
                className="font-normal xl:ml-[1px] lg:ml-[1px] ml-[2px] mt-[10.62px] 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[8px] xl:mt-[9px] not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-black_901 w-[auto]"
              ...
              <Text
                className="font-normal ml-[1px] lg:mt-[6px] xl:mt-[7px] mt-[8.06px] 2xl:mt-[8px] 3xl:mt-[9px] not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-black_901 w-[auto]"
              ...
              <Text
                className="font-normal xl:ml-[2px] lg:ml-[2px] ml-[3px] mt-[1px] not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-black_901 w-[auto]"
              ...
              <Text
                className="font-normal xl:mt-[10px] mt-[11.34px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-black_901 w-[auto]"
              ...
              >
                <Input
                  className="bg-transparent border-0 font-normal not-italic p-[0] pl-[0] lg:pr-[27px] xl:pr-[31px] pr-[35px] 3xl:pr-[42px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] placeholder:text-bluegray_201 text-bluegray_201 w-[100%]"
                  WrapClassName="2xl:pr-[17px] 3xl:pl-[19px] 3xl:pr-[21px] 3xl:py-[9px] border border-gray_201 border-solid flex lg:pl-[12px] lg:pr-[13px] lg:py-[6px] pl-[16px] pr-[17.66px] py-[8px] rounded-radius4 w-[100%] xl:pl-[14px] xl:pr-[15px] xl:py-[7px]"
                  compId="4797:11453"
                  comWidth={0}
                  comHeight={39}
                  compLeft={0}
